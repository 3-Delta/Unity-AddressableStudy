...
{
    internal class InitOperation : AsyncOperationBase<IResourceLocator>
    {
        ...
        InitObjectsOperation m_InitGroupOps;

        public InitOperation(AddressablesImpl aa)
        {
            this.impl = aa;
        ...
        {
            get { return "InitOperation"; }
        }

        internal static AsyncOperationHandle<IResourceLocator> CreateInitOperation(AddressablesImpl aa, string playerSettingsLocation, string providerSuffix)
        {
            ...
            var initOp = new InitOperation(aa);
            ...
            initOp.m_InitGroupOps = new InitObjectsOperation();
        ...
        protected override void WhenDependentCompleted()
        {
            ...
            this.impl.ResourceManager.postProfilerEvents = rtd.ProfileEvents;
            WebRequestQueue.SetMaxConcurrentRequests(rtd.MaxConcurrentWebRequests);
            this.impl.CatalogRequestsTimeout = rtd.CatalogRequestsTimeout;
            ...
            this.impl.Release(m_rtdOp);
            if (rtd.CertificateHandlerType != null)
                this.impl.ResourceManager.CertificateHandlerInstance = Activator.CreateInstance(rtd.CertificateHandlerType) as CertificateHandler;
            ...
            this.impl.AddResourceLocator(locMap);
            ...
            if (!locMap.Locate(ResourceManagerRuntimeData.kCatalogAddress, typeof(ContentCatalogData), out catalogs))
            {
                ...
                this.impl.RemoveResourceLocator(locMap);
        ...
        static void LoadProvider(AddressablesImpl addressables, ObjectInitData providerData, string providerSuffix)
        {
        ...
        {
            return LoadContentCatalog(this.impl, loc, providerSuffix, remoteHashLocation);
        }
        ...
        {
            Addressables.LogFormat("Addressables - loading content catalog from {0}.", this.impl.ResourceManager.TransformInternalId(catalogs[index]));
