...
namespace UnityEngine.AddressableAssets
{
    ...
    public static class Addressables
    {
        ...
        {
            get { return Impl.WebRequestOverride; }
            set { Impl.WebRequestOverride = value; }
        }
        ...
        {
            return Impl.UnloadSceneAsync(scene, unloadOptions, autoReleaseHandle);
        }
        ...
        {
            return Impl.UnloadSceneAsync(handle, unloadOptions, autoReleaseHandle);
        }
        ...
        {
            return Impl.UnloadSceneAsync(scene, UnloadSceneOptions.None, autoReleaseHandle);
        }
        ...
        {
            return Impl.UnloadSceneAsync(handle, UnloadSceneOptions.None, autoReleaseHandle);
        }
        ...
        {
            return Impl.UpdateCatalogs(catalogs, autoReleaseHandle, false);
        }
        ...
        {
            return Impl.UpdateCatalogs(catalogs, autoReleaseHandle, autoCleanBundleCache);
        }
        ...
        {
            return Impl.CleanBundleCache(catalogsIds, false);
        }
    }
}
